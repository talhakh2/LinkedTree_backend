...
import { getTrialUser, updateTrialUser, getUserData, login, RegisterUser, sendEmail, updateUserData, verifyUser, getAllUsers, getAllPages, getAdminDashboardData, sendDemoRequest, manageUser} from '../Controller/RegisterationController.js';
